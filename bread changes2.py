...
def dashboard():
    ...
    print(f"Itens com estoque baixo: {estoque_baixo}")
...
def main():
    while True:
        ...
        print("\n1-Cadastrar | 2-Listar | 3-Editar | 4-Buscar | 5-Add Estoque | 6-Remover | 7-Total | 8-Baixo | 9-Vender | 10-Dashboard | 0-Sair")
        op = input("Opção: ")
        ...
        elif op == "9": vender_produto()
        elif op == "10": dashboard()
        elif op == "0": break
        else: print("Invalido")
